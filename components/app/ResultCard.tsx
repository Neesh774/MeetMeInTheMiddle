...
export default function ResultCard({ location }: { location: Location }) {
  ...
  const [image, setImage] = useState<string | undefined>(location.icon);
  ...
  return (
    <div
      className="flex flex-col w-full gap-2 bg-white dark:bg-zinc-800 rounded-lg p-2 transition-colors duration-300"
    ...
    >
      {image ? (
        ...
        <div className="flex items-center justify-center w-full h-48 rounded-md bg-slate-100 dark:bg-zinc-700">
      ...
      <div className="flex flex-row justify-between">
        ...
        <div className="flex flex-col justify-start items-center gap-2 mr-2 my-2">
          {website && (
            <a href={website}>
